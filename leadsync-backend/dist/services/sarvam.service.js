...
class SarvamService {
    constructor() {
        this.apiUrl = "https://api.sarvam.ai/v1/intent-extraction"; // Hypothetical Endpoint
     ...
     */
    async speechToText(audioBuffer, filename = "voice.ogg") {
        if (!this.apiKey) {
        ...
        try {
            ...
            const response = await axios_1.default.post("https://api.sarvam.ai/speech-to-text", form, {
                headers: {
                    ...form.getHeaders(),
    ...
    async textToSpeech(text, languageCode = "en-IN") {
        ...
        try {
            const response = await axios_1.default.post("https://api.sarvam.ai/text-to-speech", {
    ...
    async analyzeIntent(text) {
        ...
        try {
            const response = await axios_1.default.post("https://api.sarvam.ai/v1/chat/completions", {
                model: "sarvam-m",
                messages: [
                    {
                        role: "user",
