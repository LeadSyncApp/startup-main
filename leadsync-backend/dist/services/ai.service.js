...
exports.generateLearnedContext = generateLearnedContext;
exports.generateShopReply = generateShopReply;
...
async function generateLearnedContext(knowledgeBase) {
...
async function generateShopReply(input) {
    try {
...
Return VALID JSON ONLY in this schema:
{
  ...
  "clarifying_question": "string|null"
        ...
        // SAFE PARSE GUARD
        const parsed = (0, shop_ai_utils_1.safeJsonParse)(rawOutput, {
            reply: "I'm sorry, I'm having trouble processing that. How can I help you with our menu?",
            state_updates: input.session_state
        });
        return {
            replyText: (0, shop_ai_utils_1.sanitizeReply)(parsed.reply || parsed.clarifying_question || "How can I help you?"),
 ...
 */
async function generateBotReply(message, businessName, businessType, structuredMenu, history, orderHistory, customerProfile, inputModality = "text", controlFlags = {}, detectedLanguage = "en-IN") {
    ...
    const menuSnapshot = (0, shop_ai_utils_1.getMenuSnapshot)(structuredMenu);
    const retrieved = (0, shop_ai_utils_1.calculateRetrieval)(message, menuSnapshot);
